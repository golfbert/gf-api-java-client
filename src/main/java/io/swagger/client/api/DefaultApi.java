...
public class DefaultApi {
    ...
    /**
     * v1/courses/_id_ (asynchronously)
     * Retrieves a course&#39;s details. This call expands on the information returned by the course listings call.
     * @param id the id of the course whose information to be returned (required)
    ...
    private com.squareup.okhttp.Call getHoleCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/holes/{id}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    private com.squareup.okhttp.Call getScorecardCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/courses/{id}/scorecard".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    /**
     * v1/courses/_id_/scorecard (asynchronously)
     * Retrieves a course&#39;s scorecard. An example of information returned can be found [here.](http://golfbert.com/courses/scorecard/17078)
     * @param id the course id whose scorecard to return (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private com.squareup.okhttp.Call listCourseTeeboxesForCourseCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/courses/{id}/teeboxes".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
     ...
     * @return List&lt;Courseteebox&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Courseteebox> listCourseTeeboxesForCourse(Integer id) throws ApiException {
        ApiResponse<List<Courseteebox>> resp = listCourseTeeboxesForCourseWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Retrieves a course&#39;s teeboxes.
     * @param id the course id (required)
     * @return ApiResponse&lt;List&lt;Courseteebox&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Courseteebox>> listCourseTeeboxesForCourseWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = listCourseTeeboxesForCourseCall(id, null, null);
        Type localVarReturnType = new TypeToken<List<Courseteebox>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * v1/courses/_id_/teeboxes (asynchronously)
     * Retrieves a course&#39;s teeboxes.
     * @param id the course id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listCourseTeeboxesForCourseAsync(Integer id, final ApiCallback<List<Courseteebox>> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Course> listCourses(Integer limit, Integer marker, String name, String city, String state, String zipcode, Double lat, Double _long) throws ApiException {
        ApiResponse<List<Course>> resp = listCoursesWithHttpInfo(limit, marker, name, city, state, zipcode, lat, _long);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Course>> listCoursesWithHttpInfo(Integer limit, Integer marker, String name, String city, String state, String zipcode, Double lat, Double _long) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listCoursesAsync(Integer limit, Integer marker, String name, String city, String state, String zipcode, Double lat, Double _long, final ApiCallback<List<Course>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listFlagColorsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/teeboxcolors".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<String> listFlagColors() throws ApiException {
        ApiResponse<List<String>> resp = listFlagColorsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<String>> listFlagColorsWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listFlagColorsAsync(final ApiCallback<List<String>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listHolesCall(Integer courseId, Integer limit, Integer marker, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/holes/".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Hole> listHoles(Integer courseId, Integer limit, Integer marker) throws ApiException {
        ApiResponse<List<Hole>> resp = listHolesWithHttpInfo(courseId, limit, marker);
        return resp.getData();
    }
     ...
     * @param limit maximum number of results to return (optional, default to 18)
     * @param marker marker of where to start returning results (in this case hole number) (optional, default to 1)
     * @return ApiResponse&lt;List&lt;Hole&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Hole>> listHolesWithHttpInfo(Integer courseId, Integer limit, Integer marker) throws ApiException {
        com.squareup.okhttp.Call call = listHolesCall(courseId, limit, marker, null, null);
        Type localVarReturnType = new TypeToken<List<Hole>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listHolesAsync(Integer courseId, Integer limit, Integer marker, final ApiCallback<List<Hole>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listHolesForCourseCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/courses/{id}/holes".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Hole> listHolesForCourse(Integer id) throws ApiException {
        ApiResponse<List<Hole>> resp = listHolesForCourseWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Hole>> listHolesForCourseWithHttpInfo(Integer id) throws ApiException {
    ...
    /**
     * v1/courses/_id_/holes (asynchronously)
     * Retrieves a course&#39;s holes&#39; information.
     * @param id the course id whose holes info to return (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listHolesForCourseAsync(Integer id, final ApiCallback<List<Hole>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listPolygonsForHoleCall(Integer id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/holes/{id}/polygons".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
     ...
     * @param id the hole id (required)
     * @return List&lt;Holepolygon&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Holepolygon> listPolygonsForHole(Integer id) throws ApiException {
        ApiResponse<List<Holepolygon>> resp = listPolygonsForHoleWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Retrieves a holes&#39;s polygons. This information can be used to render the hole accurately on top of a map.
     * @param id the hole id (required)
     * @return ApiResponse&lt;List&lt;Holepolygon&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Holepolygon>> listPolygonsForHoleWithHttpInfo(Integer id) throws ApiException {
        com.squareup.okhttp.Call call = listPolygonsForHoleCall(id, null, null);
        Type localVarReturnType = new TypeToken<List<Holepolygon>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * v1/holes/_id_/polygons (asynchronously)
     * Retrieves a holes&#39;s polygons. This information can be used to render the hole accurately on top of a map.
     * @param id the hole id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listPolygonsForHoleAsync(Integer id, final ApiCallback<List<Holepolygon>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listTeeboxTypesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/teeboxtypes".replaceAll("\\{format\\}","json");
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<String> listTeeboxTypes() throws ApiException {
        ApiResponse<List<String>> resp = listTeeboxTypesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<String>> listTeeboxTypesWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listTeeboxTypesAsync(final ApiCallback<List<String>> callback) throws ApiException {
    ...
    private com.squareup.okhttp.Call listTeeboxesForHoleCall(Integer id, String color, String teeboxtype, Integer par, Integer handicap, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/holes/{id}/teeboxes".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
     ...
     * @return List&lt;Holeteebox&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Holeteebox> listTeeboxesForHole(Integer id, String color, String teeboxtype, Integer par, Integer handicap) throws ApiException {
        ApiResponse<List<Holeteebox>> resp = listTeeboxesForHoleWithHttpInfo(id, color, teeboxtype, par, handicap);
        return resp.getData();
    }
     ...
     * @param par only show holes with a specific par (optional)
     * @param handicap only show holes with a specific handicap (optional)
     * @return ApiResponse&lt;List&lt;Holeteebox&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Holeteebox>> listTeeboxesForHoleWithHttpInfo(Integer id, String color, String teeboxtype, Integer par, Integer handicap) throws ApiException {
        com.squareup.okhttp.Call call = listTeeboxesForHoleCall(id, color, teeboxtype, par, handicap, null, null);
        Type localVarReturnType = new TypeToken<List<Holeteebox>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * v1/holes/_id_/teeboxes (asynchronously)
     * Retrieves a holes&#39;s teeboxes.
     * @param id the hole id (required)
     * @param color teebox color to filter by (optional)
     * @param teeboxtype teebox type to filter by (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listTeeboxesForHoleAsync(Integer id, String color, String teeboxtype, Integer par, Integer handicap, final ApiCallback<List<Holeteebox>> callback) throws ApiException {
